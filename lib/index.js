...
app.post('/stepExecution', (req, res) => {
    ...
    stateManager.addStepExecution(workflowName, stepName, workflowExecutionUuid, stepExecutionUuid, instanceUuid, receiveTime, lastExecutionDuration, lastNetworkLatencyToNextStep, coldExecution);
