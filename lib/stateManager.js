...
class StateManager {
    ...
    addStepExecution(workflowName, stepName, workflowExecutionUuid, stepExecutionUuid, instanceUuid, receiveTime, lastMeasuredExecutionDuration, lastNetworkLatencyToNextStep, coldExecution = null) {
        ...
        let newStepExecution = new StepExecution(workflowName, functionName, workflowExecutionUuid, stepExecutionUuid, instanceUuid, receiveTime, coldExecution);
