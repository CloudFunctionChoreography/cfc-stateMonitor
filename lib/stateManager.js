...
class StateManager {
    ...
    addStepExecution(workflowName, stepName, workflowUuid, stepExecutionUuid, instanceUuid, receiveTime, lastMeasuredExecutionDuration, lastNetworkLatencyToNextStep, coldExecution = null) {
        ...
        let newStepExecution = new StepExecution(workflowName, functionName, workflowUuid, stepExecutionUuid, instanceUuid, receiveTime, coldExecution);
